...
@Component({
  selector: 'app-kpi-chart-structure-average-duration-for-transfer-completion',
  imports: [
    CommonModule,
    TranslateModule,
...
export class KpiChartStructureAverageDurationForTransferCompletionComponent implements OnInit, OnChanges {
  ...
  loadChartData() {
    forkJoin({
      averageDuration: this.kpiService.GetAverageDurationForTransferCompletionV2(this.structureId, this.year),
