...
@Component({
  selector: 'app-kpi-chart-structure-average-duration-for-transfer-delay',
  imports: [
    CommonModule,
    TranslateModule,
...
export class KpiChartStructureAverageDurationForTransferDelayComponent implements OnChanges, OnInit {
  ...
  loadChartData() {
    forkJoin({
      averageDuration: this.kpiService.GetAverageDurationForTransferDelayV2(this.structureId, this.year),
