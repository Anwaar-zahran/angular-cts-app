...
@Component({
  selector: 'app-kpi-chart-user-average-duration-for-correspondence-delay',
  imports: [
    CommonModule,
    TranslateModule,
  ...
  templateUrl: './kpi-chart-user-average-duration-for-correspondence-delay.component.html',
  styleUrl: './kpi-chart-user-average-duration-for-correspondence-delay.component.scss'
})
export class KpiChartUserAverageDurationForCorrespondenceDelayComponent implements OnChanges, OnInit {
  @Input() year!: number;
  ...
  loadChartData() {
    forkJoin({
      averageDuration: this.kpiService.GetAverageDurationForCorrespondenceDelayV3(this.structureId, this.year, this.userId),
